    ...
    <div className='mx-10 my-[60px] lmd:mx-20'>
      ...
      <div className='flex flex-wrap'>
        ...
        <div className='w-full justify-end lmd:w-1/1 lg:w-1/3 h-[300px] flex  flex-col'>
          <div className='mb-[20px] w-[90%] bg-white text-black flex lg:my-auto p-5 rounded-xl'>
            ...
            <div className='ml-3 mt-1'>
              ...
              <p className='font-semibold text-[16px] lg:text-[14px]'>email@example.com</p>
            </div>
          </div>
          <div className='mb-[20px] w-[90%] bg-white text-black flex lg:my-auto p-5 rounded-xl'>
            <img src={Location.src} width={55} height={35} alt="Location Icon" />
            <div className='ml-3 mt-1'>
        ...
        <div className='w-full lmd:w-1/1 lg:w-1/3 h-[300px] flex flex-col lg:items-end'>
          <div className='mt-[20px] w-[90%] bg-white text-black flex p-5 lg:my-auto
          
          rounded-xl'>
            <img src={Instagram.src} width={55} height={35} alt="Instagram Icon" />
            <div className='ml-3 mt-1'>
          ...
          rounded-xl'>
            <img src={Linkedin.src} width={55} height={35} alt="LinkedIn Icon" />
            <div className='ml-3 mt-1'>
