...
const ContactUsPageHero = () => {
  ...
  } bg-[url('../assets/ContactUsImg.jpg')] sm:bg-[url('../assets/ContactUsImg.jpg')] bg-cover bg-center`}
>
          
          {isOpen ? '':<div className='flex h-16 mx-10 lmd:mx-20 items-center justify-between'>
            <Link href='/' className=' text-[20px] '>Nextgenn</Link>
